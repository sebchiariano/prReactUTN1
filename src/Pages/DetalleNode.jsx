...
import {getProductById,deleteProductById} from '../Services/ProductosService'
...
function Detalle(props){
    ...
    const handleDelete = async () =>{
            ...
            try{
                deleteProductById(params.id).then(res => res.text()) // or res.json()
                .then(res => {
