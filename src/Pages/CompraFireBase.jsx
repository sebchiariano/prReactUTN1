            ...
            async function request(){
                try{
                    ...
                    if(consultaBase){
                        ...
                        setLoading(false);
                        setPrecio(consultaBase.data().price)
                        setTotal(consultaBase.data().price)
                        setNombre(consultaBase.data().title)
    ...
    else
    {
        return(
            <div style={{margin:"0 auto", alignItems:"center", textAlign:"center"}}>
              ...
              <div>
                  <span>
                         <Image src={producto.data().pictures[0].secure_url} thumbnail />
                  </span>
             ...
             <div hidden={!isVisibleDesc || isLoadingDesc}>
                  <span className="tit">
                   ...
                   <span>
                     {isVisibleDesc ? producto.data().description : ''}
